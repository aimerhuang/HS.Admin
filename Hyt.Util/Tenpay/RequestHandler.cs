...
namespace Hyt.Util.Tenpay
{
    public class RequestHandler
    {
        public RequestHandler(System.Web.HttpContext httpContext, string tenpay_key, string gateWay)
        {
            parameters = new Hashtable();

            this.httpContext = httpContext;
            //this.setGateUrl("https://www.tenpay.com/cgi-bin/v1.0/service_gate.cgi");
            this.setGateUrl(gateWay);
        ...
        public virtual string getRequestURL(string url = "")
        {
            this.createSign();
        ...
        */
        protected virtual void createSign()
        {
            ...
            string sign = GetMD5(sb.ToString(), getCharset()).ToUpper();
