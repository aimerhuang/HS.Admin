...
{
    public delegate object DJdConvert(IJdReader reader, Type type);

    /// <summary>
    /// Jd API响应读取器接口。响应格式可以是XML, JSON等等。
    /// </summary>
    public interface IJdReader
    {
        /// <summary>
        /// 判断响应中是否包含指定的属性。
        /// </summary>
        ...
        object GetReferenceObject(object name, Type type, DJdConvert convert);
        ...
        IList GetListObjects(string listName, string itemName, Type type, DJdConvert convert);
    }
}
