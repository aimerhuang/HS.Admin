...
namespace Extra.Erp.XingYe
{
    ...
    public class XingYeNullProvider : IXingYeProvider
    {
        #region 库存查询
        ...
        {
            //var result = XingYeCore.Instance.OtherIssueBillFacade(model, 借货状态.借货, description,flowIdentify,null, false, false);
            //return result;
        ...
        {
            //var result = XingYeCore.Instance.OtherIssueBillFacade(model, 借货状态.还货, description,flowIdentify,null, false, false);
            //return result;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        ...
        {
            //var status = XingYeCore.Instance.SaleIssueBillFacade(model, 出库状态.出库, customer, description,flowIdentify,null, false, false);
            //return status;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        ...
        {
            //var status = XingYeCore.Instance.SaleIssueBillFacade(model, 出库状态.退货, customer, description,flowIdentify,null, false, false);
            //return status;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        /// <summary>
