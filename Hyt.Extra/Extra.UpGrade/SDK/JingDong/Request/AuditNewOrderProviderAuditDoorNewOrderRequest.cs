...
public   		string
   applyReson  { get; set; }
		...
		public IDictionary<string, string> GetParameters()
        {
			...
			parameters.Add("afsApplyDetailId2", this.afsApplyDetailId2);
			parameters.Add("wareId2", this.wareId2);
			parameters.Add("wareName2", this.wareName2);
