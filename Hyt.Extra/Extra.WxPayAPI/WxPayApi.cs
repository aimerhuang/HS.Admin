    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10, 
            string AppId = "", string MacId = "", string key = "")
        {
            ...
            {
                MacId = WxPayConfig.MCHID;
            }
           
            inputObj.SetValue("spbill_create_ip", WxPayConfig.IP);//终端ip
            inputObj.SetValue("appid",AppId);//公众账号ID
            inputObj.SetValue("mch_id", MacId);//商户号
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 20, 
            string AppId = "", string MacId = "", string key = "")
        {
