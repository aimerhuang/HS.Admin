...
{
public class AuditDoorPickwareExportAuditDoorPickwareRequest : IJdRequest<AuditDoorPickwareExportAuditDoorPickwareResponse>
{
		                                                                                                                                                                                                                                                                                                                                                                                                                                   		public  		string
   serviceId  { get; set; }
...
public   		Nullable<int>
   afterServiceProvider  { get; set; }
        ...
        {
			return "jingdong.AuditDoorPickwareExport.auditDoorPickware";
        }
