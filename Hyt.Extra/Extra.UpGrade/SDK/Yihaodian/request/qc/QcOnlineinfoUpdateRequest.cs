...
namespace Extra.UpGrade.SDK.Yihaodian.Request
{
	...
	/// 反馈质检订单和资质质检结果
	/// </summary>
	public class QcOnlineinfoUpdateRequest 
		: IYhdRequest<QcOnlineinfoUpdateResponse> 
	{
		/**商家订单ID */
		...
		/**品牌相关数据列表。具体参数封装为json格式（内部body参照QcBrandInfo对象） */
		...
		{
			return "yhd.qc.onlineinfo.update";
		}
