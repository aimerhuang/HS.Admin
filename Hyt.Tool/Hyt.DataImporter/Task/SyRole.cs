...
{
    public class SyRole :BaseTask
    {
        public override void Read()
        {

            string sSql = "SELECT *FROM ImportData.dbo.SyRole ORDER BY sysno";
            ...
            using (SqlConnection myConn = new SqlConnection(ConfigurationManager.AppSettings["sqlconnectionstring"].ToString()))
            {
                ...
                myAdapter.Fill(Common.RDS, "SyRole");

            }
        }

        /*sysno, rolename, description, createdby, createddate, lastupdateby, lastupdatedate, status*/
        public override void SetColumnMapping(OracleBulkCopy bcp)
        {
            bcp.ColumnMappings.Add("sysno", "sysno");
            bcp.ColumnMappings.Add("rolename", "rolename");
