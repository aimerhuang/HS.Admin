...
using Extra.Erp.Control.LiJiaNew;
using System.Net;
...
namespace Extra.Erp.LiJia
{
    ...
    internal sealed class LiJiaCore
    {
        #region Private
        ...
        public static LiJiaCore Instance
        {
            get { return new LiJiaCore(); }
        }
        /// <summary>
        /// 初始化请求数据
        /// </summary>
        ...
        //private readonly static Hyt.Model.LiJiaNew.LiJiaConfig config = ;
        ...
        public string GetSign(string jiekouUrl)
        {
            ...
            string qianming = ("post" + LiJiaConfig.ApiUrl + jiekouUrl + LiJiaConfig.AppSecret + timestamp).ToLower();
        ...
        public static void WriteLog(int easSysNo, string xmlContent,string dateTime,bool isAgain)
        {
            if (isAgain)
            {
                ...
                context.Sql(
                    "insert into LiJiaSyncRequestLog(LiJiaSyncLogSysNo,Content,CreatedDate) values(@LiJiaSyncLogSysNo,@Content,@CreatedDate)")
                    .Parameter("LiJiaSyncLogSysNo", easSysNo)
