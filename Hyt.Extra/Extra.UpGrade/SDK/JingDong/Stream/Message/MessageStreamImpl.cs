...
namespace Extra.UpGrade.SDK.JingDong.Stream.Message
{
    public class MessageStreamImpl : AbstractStreamImpl
    {
        ...
        private JdCometStreamImpl cometStreamImpl;
        ...
        public MessageStreamImpl(StreamMsgConsumeFactory msgConsumeFactory,
                HttpResponse response, IJdCometMessageListener msgListener, JdCometStreamImpl cometStreamImpl)
        ...
        public override IJdCometMessageListener GetMessageListener()
        {
