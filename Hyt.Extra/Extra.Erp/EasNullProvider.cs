...
namespace Extra.Erp
{
    ...
    public class EasNullProvider : IEasProvider
    {
        #region 库存查询
        ...
        {
            //var result = EasCore.Instance.OtherIssueBillFacade(model, 借货状态.借货, description,flowIdentify,null, false, false);
            //return result;
        ...
        {
            //var result = EasCore.Instance.OtherIssueBillFacade(model, 借货状态.还货, description,flowIdentify,null, false, false);
            //return result;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        ...
        {
            //var status = EasCore.Instance.SaleIssueBillFacade(model, 出库状态.出库, customer, description,flowIdentify,null, false, false);
            //return status;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        ...
        {
            //var status = EasCore.Instance.SaleIssueBillFacade(model, 出库状态.退货, customer, description,flowIdentify,null, false, false);
            //return status;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
        ...
        {
            //var status = EasCore.Instance.ReceivingBillFacade(model, receivingType, customer, description, flowIdentify,null, false, false);
            //return status;
            return new Result { Message = Model.EasConstant.EAS_MESSAGE_CLOSE, Status = false };
        }
