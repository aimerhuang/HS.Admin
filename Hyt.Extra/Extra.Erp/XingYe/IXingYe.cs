...
namespace Extra.Erp.XingYe
{
    ...
    public interface IXingYeProvider
    {
        #region 库存查询
        ...
        /// <param name="erpWarehouseSysNo">XingYe仓库编号</param>
       ...
       //void ReturnAsync(List<BorrowInfo> model, string description);
        ...
        /// <param name="description">XingYe单据摘要(商城订单号)</param>
        ...
        /// <returns></returns>
        /// <remarks>2018-03-22 罗熙 添加</remarks>
        Result<string> GetData(CBXingYeSyncLog model);
        /// <summary>
        /// 获取XingYe全部计量单位
        /// </summary>
        /// <returns></returns>
