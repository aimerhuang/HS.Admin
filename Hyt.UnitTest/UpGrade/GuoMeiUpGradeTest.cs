...
namespace Hyt.UnitTest.UpGrade
{
    #region 国美单元测试
    [TestClass]
    public class GuoMeiUpGradeTest
    {
        #region 附加测试特性
        [ClassInitialize]
        ...
        public void GetOrderList()
        {
            var param = new OrderParameters()
            {
                PageIndex = 1,
                PageSize = 20,
                StartDate = Convert.ToDateTime("2017-08-20 00:00:00"),
                EndDate = Convert.ToDateTime("2017-09-01 00:00:00")
            };

            var g = new Extra.UpGrade.UpGrades.GuoMeiUpGrade();
