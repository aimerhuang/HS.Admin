...
{
    public class WhWarehousePickupType :BaseTask
    {
        public override void Read()
        {

            string sSql = "SELECT *FROM ImportData.dbo.WhWarehousePickupType ORDER BY sysno";
            ...
            using (SqlConnection myConn = new SqlConnection(ConfigurationManager.AppSettings["sqlconnectionstring"].ToString()))
            {
                ...
                myAdapter.Fill(Common.RDS, "WhWarehousePickupType");

            }
        }

        /*sysno,pickuptypesysno, warehousesysno, status, createdby, createddate, lastupdateby, lastupdatedate*/
