...
namespace Hyt.Model.MallEhking
{
    public class MEProductUpdate
    {
        ...
        /// </summary>
        /// <must>非空</must>
        /// <remarks>商品在易扫购系统中的唯一id</remarks>
        ...
        public List<MEProductUpdatePicture> pictureList
        {
            get;
            set;
        }
    ...
    /// 图片信息
    /// </summary>
    public class MEProductUpdatePicture
    {
        /// <summary>
        /// 图片
        /// </summary>
