...
{
    public class SyMyMenu : BaseTask
    {
        public override void Read()
        {

            string sSql = "SELECT *FROM  ImportData.dbo.SyMyMenu ORDER BY sysno";
            ...
            using (SqlConnection myConn = new SqlConnection(ConfigurationManager.AppSettings["sqlconnectionstring"].ToString()))
            {
                ...
                myAdapter.Fill(Common.RDS, "SyMyMenu");

            }
        }

        /*SysNo, UserSysNo, MenuSysNo, CreatedBy, CreatedDate, LastUpdateBy, LastUpdateDate*/
