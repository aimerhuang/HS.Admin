...
{
public class EclpOrderAsynAddOrderRequest : IJdRequest<EclpOrderAsynAddOrderResponse>
{
...
public   		string
   orderBatchNo  { get; set; }

                  
                                                            
                                                          
public   		Nullable<int>
   orderBatchQty  { get; set; }

                  
                                                            
                                                          
public   		string
   transactionSource  { get; set; }
   ...
   printName  { get; set; }
		...
		public IDictionary<string, string> GetParameters()
        {
			...
			parameters.Add("transactionSource", this.transactionSource);
			parameters.Add("goodsNo", this.goodsNo);
			parameters.Add("price", this.price);
			parameters.Add("quantity", this.quantity);
			parameters.Add("serialNo", this.serialNo);
			parameters.Add("printName", this.printName);
