...
namespace Extra.UpGrade.SDK.JingDong.Stream
{
    public class Configuration : IHttpConnectionConfiguration, IMessageHandlerConfiguration
    {
        ...
        private List<JdCometStreamRequest> connectReqParam;
        ...
        {
            JdCometStreamRequest cometReq = new JdCometStreamRequest(appkey, secret, userid, null);
            connectReqParam = new List<JdCometStreamRequest>(1);
        ...
        {
            JdCometStreamRequest cometReq = new JdCometStreamRequest(appkey, secret, userid, connectId);
            connectReqParam = new List<JdCometStreamRequest>(1);
            connectReqParam.Add(cometReq);
        }
         ...
         * @param cometRequest
         */
        public Configuration(List<JdCometStreamRequest> cometRequest)
        {
        ...
        public List<JdCometStreamRequest> GetConnectReqParam()
        {
