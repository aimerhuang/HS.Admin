...
(function ($) {
    ...
    $.extend($.validator, {
        ...
        methods: {
            ...
            //本文本框数值 不大于 目标文本框内数值 2013-07-02 郑荣华
            lessthan: function (value, element, params) {
                return parseFloat($(params).val()) >= parseFloat(value);
            },
            //本文本框数值 + 目标文本框内数值>=0 2013-08-08 郑荣华
            sumtwo: function (value, element, params) {
                return parseFloat($(params).val()) + parseFloat(value) >= 0;
            },
...
//select选择项验证
jQuery.validator.addMethod("select", function (value, element, defaultValue) {
...
// 字母空格验证
jQuery.validator.addMethod("chineseSpelling", function (value, element) {
...
// 数组最小范围
jQuery.validator.addMethod("minLimitNumber", function (value, element, param) {
...
// 数组最大范围
jQuery.validator.addMethod("maxLimitNumber", function (value, element, param) {
    var reg = /^-{0,1}\d+\.{0,1}\d{0,}$/;
    if (this.optional(element) || (reg.test(value))) {
        if (parseFloat(value) > parseFloat(param)) {
            return false;
