...
namespace Hyt.Infrastructure.Pager
{
    public class PagerOptions
    {
        public PagerOptions()
        {
            ...
            MaxPageIndex = 0;
            PrevPageFormatString = "";
            NextPageFormatString = "";
        }
        ...
        /// 上一页样式
        /// </summary>
        public string PrevPageFormatString { get; set; }
        /// <summary>
        /// 下一页样式
        /// </summary>
        public string NextPageFormatString { get; set; }
        /// <summary>
        /// 是否显示数字页索引按钮及更多页按钮
        /// </summary>
        ...
        /// 包容分页元素的html文本格式字符串
        /// </summary>
        /// <remarks>2013-9-5 朱家宏 添加</remarks>
        public string AnchorWrapperFormatString { get; set; }
    }
