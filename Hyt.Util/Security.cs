...
namespace Hyt.Util
{
    ...
    public class Security
    {
        ...
        /// 通过ASCII 码加密数据
        /// </summary>
        /// <param name="strText">密文字符串</param>
        /// <returns>返回密文内容</returns>
        ...
        /// 加密密钥
        /// </summary>
        private const string CONST_ENCRYPT_KEY = "$d4@3~14";
        ...
        public static string EncryptDES(string encryptString)
        {
            try
            {
                byte[] rgbKey = Encoding.UTF8.GetBytes(CONST_ENCRYPT_KEY.Substring(0, 8));
                byte[] rgbIV = Keys;
        ...
        public static string EncodeBase64(byte[] buffer)
        {
            ...
            try
            {
                encodeString = Convert.ToBase64String(buffer);
            }
            catch
            {
                encodeString = "";
        ...
        /// <returns></returns>
        public static string EncodeBase64(Encoding encode, string code)
        {
            string encodeString = "";
        ...
        public static string DecodeBase64(Encoding encode, string code)
        {
            string decodeString = "";
        ...
        public static String byte2hex(byte[] bytes)
        {
            ...
            {
                String hex = Convert.ToInt32(bytes[i] & 0xFF).ToString("x2");
                if (hex.Length == 1)
                {
                    sign.Append("0");
                }
        ...
        public static string BSEncrypMD5(string content)
        {
            System.Security.Cryptography.MD5 md5 = System.Security.Cryptography.MD5.Create();  
            string t2 = byte2hex(md5.ComputeHash(UTF8Encoding.UTF8.GetBytes(content)));
            t2 = t2.Replace("-", "");
            return t2;
        }
